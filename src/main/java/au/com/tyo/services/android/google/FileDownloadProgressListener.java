...
public class FileDownloadProgressListener implements MediaHttpDownloaderProgressListener {
  ...
  public void progressChanged(MediaHttpDownloader downloader) {
    if (downloader.getDownloadState() == MediaHttpDownloader.DownloadState.MEDIA_IN_PROGRESS) {
    }
    else if (downloader.getDownloadState() ==  MediaHttpDownloader.DownloadState.MEDIA_COMPLETE) {
    }
  }
}
